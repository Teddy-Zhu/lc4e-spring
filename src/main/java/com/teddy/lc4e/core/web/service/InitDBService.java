...
public class InitDBService {
    ...
    public boolean initdb() {
        ...
        commonConfigRepository.insert(new SysComVar(null, "Register", true ,"Register is forbid","",new Date(),null));
        commonConfigRepository.insert(new SysComVar(null, "SimpleRegister", true, new Date()));
        //clear cache
        cacheHandler.clear(Global.VAR);
        //use cache true
        cacheHandler.setCache(Global.VAR, Global.Cache, new SysComVar(null,Global.Cache,true,new Date()));
